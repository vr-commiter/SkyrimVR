...
public:
	...
	UInt32			 baseObject;	// 08
	UInt32			 originalRefr;	// 0C
	UInt16			 uniqueID;		// 10
	bool			 equipped;		// 12
	UInt8			 pad13;			// 13
	UInt32			 pad14;			// 14
...
public:
	...
	EventDispatcher<TESFurnitureEvent>					unk580;					//  580 - sink offset 088
	EventDispatcher<void>								unk5D8;					//  5D8 - sink offset 090
	EventDispatcher<TESHitEvent>						unk630;					//  630 - sink offset 098
	...
	EventDispatcher<TESQuestStageEvent>								unkAA8;					//  AA8 - sink offset 100
